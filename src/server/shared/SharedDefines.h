...
// Original WotLK player classes. ID 10 is Ascension's reserved classless shell.
constexpr bool IsLegacyClass(uint8 classId)
{
    return classId >= CLASS_WARRIOR && classId <= CLASS_DRUID && classId != 10;
}
