-- Complete the 38 missing original-class combinations in the supplied world export.
-- Existing supported combinations, including all custom classes and death knights, are outside this update.
-- Use each race's existing ordinary starting location; class/race stats load independently.
